(function () {
    'use strict';
    var prviiAppsubscriberChannelMessage = angular.module('prviiApp.subscriberChannelMessage', []);

    prviiAppsubscriberChannelMessage.controller('subscriberChannelMessageController', ['$rootScope', '$scope', '$http', '$routeParams', 'ngProgress',
